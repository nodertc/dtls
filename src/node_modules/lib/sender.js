...
const { constants: states, getProtocol } = require('protocol/packet');
const {
  states: { SENDING },
} = require('lib/retransmitter');
...
// https://tools.ietf.org/id/draft-ietf-tls-tls13-23.html#mandatory-to-implement-cipher-suites
